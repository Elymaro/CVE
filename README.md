...
| [CVE-2025-10055](https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/time-sheets/time-sheets-213-cross-site-request-forgery)| CSRF privilege escalation | (plugin) [time-sheets](https://wordpress.org/plugins/time-sheets/) <= 2.1.3 |
...
| [CVE-2025-11254](https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/contest-gallery/contest-gallery-upload-vote-sell-with-paypal-and-stripe-2703-unauthenticated-csv-injection)| Unauthenticated CSV Injection | (plugin) [contest-gallery](https://wordpress.org/plugins/contest-gallery) <= 27.0.3 |
